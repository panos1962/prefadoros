...
στα οποία συμμετέχουν είτε ως παίκτες, είτε ως θεατές.
</p>
<p>
...
<p>
Από τις εισφορές που συνεισέφεραν ήδη αρκετοί φίλοι του «Πρεφαδόρου»
πληρώθηκαν αρκετά από τα έξοδα των τελευταίων μηνών,
...
ακόμη και από τεράστια ιδρύματα και οργανισμούς όπως η Wikipedia.
...
ο οποίος θα αναλάβει την οικονομική διαχείριση του ιστοτόπου.
Δεν μπορώ, επίσης, να δεχθώ κάρτες paysafe καθώς δεν υπάρχει τρόπος
να τις εξαργυρώσω.
</p>
<p>
Πολλοί από εσάς εκδήλωσαν την επιθυμία να συνεισφέρουν
...
στον υπάρχοντα λογαριασμό PayPal, να κάνετε το εξής:
...
Κατόπιν, παρουσία του κατόχου της κάρτας, κάντε κλικ στο πλήκτρο
<img src="<?php print $globals->server; ?>images/external/donate.gif" alt=""
	style="height: 0.46cm; margin-bottom: -0.1cm;" />
που βρίσκεται κάτω αριστερά και συμπληρώστε το ποσό που θέλετε
να καταθέσετε και τα στοιχεία της κάρτας.
...
διευθύνσεις που εμφανίζονται στο φυλλομετρητή σας, το πλήκτρο
<img src="<?php print $globals->server; ?>images/external/donate.gif" alt=""
	style="height: 0.46cm; margin-bottom: -0.1cm;" />
