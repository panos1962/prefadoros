...
class Kinisi {
	...
	public static function fix_baza_filo(&$curr, $prev) {
		...
		// Για να έχουμε κατάληξη σε μπάζα με μια ακόμη κίνηση
		// θα πρέπει να έχουν προηγηθεί τουλάχιστον μια κίνηση
		// διανομής, κάποιες δηλώσεις κλπ.
		$ncurr = count($curr);
		if ($ncurr < 5) {
			return;
		}
		...
		// ΜΠΑΖΑ να αποσταλεί χωρίς επόμενη κίνηση, ώστε το κλείσιμο
		// της μπάζας να γίνει κανονικά στην οθόνη του client.
