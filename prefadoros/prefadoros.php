...
class Prefadoros {
	...
	// διαίρεσης του timestamp καταγραφής με το 10. Πρόκειται,
	// λοιπόν, για δέκα files στα οποία ο δαίμονας καταγράφει
	// τα στοιχεία εκ περιτροπής. Επιλέγουμε να διαβάσουμε το
	// αρχείο που φέρει όνομα που αφορά στο προηγούμενο
	// δευτερόλεπτο. Μέσα στο file υπάρχουν τα εξής στοιχεία:
	//
