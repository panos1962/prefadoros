...
function welcome() {
	...
	<p class="welcome" style="margin-top: 0.0cm;">
		...
		που επειχειρεί να προσομοιάσει ένα διαδικτυακό καφενείο της πρέφας.
	...
	<p class="welcome">
		Φίλοι πρεφαδόροι, αποφύγετε τον Internet Explorer.
		Είναι καλός browser, αλλά για να δουλέψει σωστά και γρήγορα με το παιχνίδι
		απαιτεί πολλές ρυθμίσεις.
		Προτιμήστε τους Chrome, Firefox, Opera και Safari με αυτή τη σειρά.
	</p>

	<p class="welcome">
		Αν δουλεύετε Torrent, απενεργοποιήστε το όσο είστε στον Πρεφαδόρο.
