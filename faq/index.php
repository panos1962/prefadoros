...
<div id="pasxalitsa" style="display: none;">
	<p class="faqKimeno">
		...
		επαναφόρτωση κάνοντας κλικ στα αντικρυστά, στρογγυλά βελάκια
...
<div id="mobile" style="display: none;">
	<p class="faqKimeno">
		...
		Κάνοντας κλικ στο εικονίδιο κινητού τηλεφώνου στο
		control panel, ενεργοποιείτε ή απενεργοποιείτε την
