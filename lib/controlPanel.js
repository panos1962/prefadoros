controlPanel = new function() {
	...
	this.mesaExo = function(img, exo) {
		...
		img.style.borderStyle = exo ? 'outset' : 'inset';
	};
	...
	this.entasiHTML = function() {
		return '<img src="' + globals.server + 'images/controlPanel/entasi.png" ' +
			...
			'onmouseover="controlPanel.entasiDisplay();" ' +
			'onmouseout="mainFyi();" onclick="controlPanel.entasi();" />';
	};
	...
	this.alagiThesisHTML = function() {
		...
		html += '" onclick="controlPanel.diataxi(this, true);" />';
		return html;
	};
