...
controlPanel = new function() {
	...
	this.prefaDisplay = function() {
		...
		if (isPartida()) {
			html += controlPanel.klisePartidaHTML();
	...
	this.klisePartidaHTML = function() {
		return '<img src="' + globals.server + 'images/controlPanel/klisePartida.png" ' +
			'class="controlPanelIcon" alt="" title="Κλείσιμο παρτίδας" ' +
			'onclick="controlPanel.klisePartida(this);" />';
	};

	this.theatisHTML = function() {
		return '<img src="' + globals.server + 'images/controlPanel/theatis.png" ' +
			'class="controlPanelIcon" alt="" title="Παίκτης/Θεατής" ' +
			'onclick="controlPanel.theatisPektis(this);" />';
	};

	this.theatisPektis = function(img) {
		mainFyi('controlPanel::theatisPektis(): not implemented yet');
	};
	...
	this.idiotikotitaHTML = function() {
		...
		return '<img id="idiotikotitaIcon" src="' + globals.server + 'images/controlPanel/' +
			ico + '.png" title="' + controlPanel.idiotikotitaTitle() +
			'" class="controlPanelIcon" alt="" ' +
			'onclick="controlPanel.idiotikotita(event, this);" />';
	};
	...
	this.idiotikotitaCheck = function(req, ico, curSrc, nea) {
		...
		ico.src = globals.server + 'images/controlPanel/' + icon + '.png';
		ico.title = controlPanel.idiotikotitaTitle();
	};
