...
controlPanel.onload = function() {
	...
	this.emoticonsHTML = function() {
		return '<img src="' + globals.server + 'images/emoticons/xamogelo.png" ' +
	...
	this.funchatHTML = function() {
		return '<img id="funchatIcon" src="' + globals.server +
			'images/emoticons/xara.png" ' +
			'class="controlPanelIcon" alt="" ' +
			'title="Εμφάνιση funchat panel" ' +
	...
	this.kafedaki = function(ico) {
		...
		dialogos('<div class="kafedaki">' +
			msg[Math.floor(Math.random() * msg.length)] + '</div>', '4.0cm', '6.0cm');
		setTimeout(function() {
			dialogosOff();
