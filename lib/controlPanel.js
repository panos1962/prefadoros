var controlPanel = new function() {
	...
	this.activeRadio = function() {
		var x = getelid('activeRadio');
		if (notSet(x)) { return; }

		if (x.innerHTML == '') {
			x.innerHTML = '<embed type="application/x-mplayer2" ' +
				'pluginspage="http://www.microsoft.com/Windows/Downloads/' +
				'Contents/Products/MediaPlayer/" ' +
				'src="http://activeradio.gr:8000/activemp3.m3u" name="MediaPlayer" ' +
				...
				'title="ActiveRadio Live!" style="width: 6.8cm; height: 2.0cm;" />';
		}
