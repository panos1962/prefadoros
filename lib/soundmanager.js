...
////////////////////////////////////////////////////////////////
// Το τμήμα αυτό του κώδικα δεν είναι αυτόνομο αλλά πρέπει    //
// να "κολλήσει" ως τελευταίο κομμάτι του soundmanager.js     //
// που παρέχεται έτοιμο.                                      //
////////////////////////////////////////////////////////////////

// Από εδώ και κάτω υπάρχει κώδικας που έχω προσθέσει εγώ.
// Στο πρώτο μέρος υπάρχουν λίγες εντολές αρχικοποίησης,
// ενώ στο δεύτερο μέρος γίνεται αρχικοποίηση όλων των
// ήχων που χρησιμοποιούνται στο ΔΚ.

soundManager.url = globals.server + 'lib';
soundManager.flashVersion = 8;
soundManager.useFlashBlock = false;

// Εδώ γίνεται αρχικοποίηση όλων των ήχων που χρησιμοποιούνται στο ΔΚ.
// Για κάθε νέο ήχο που θέλουμε να προσθέσουμε, πρέπει να αντιγράψουμε
// το αντίστοιχο MP3 file στο "sounds" directory και να καθορίσουμε
// το id (ένα αυθαίρετο string), την default ένταση του σήματος και το
// url που πρέπει να δείχνει στο MP3 file.

soundManager.onload = function() {
	soundManager.prefaVolume = 2;
	soundManager.prefaLast = currentTimestamp();

	soundManager.createSound({
		id: 'sfirigma',
		url: globals.server + 'sounds/sfirigma.mp3',
		volume: 33,
		autoPlay: false
	});
	...
	soundManager.createSound({
		id: 'skisimo',
		url: globals.server + 'sounds/skisimo.mp3',
		volume: 30,
		autoPlay: false
	});
	...
	soundManager.createSound({
		id: 'kalathi',
		url: globals.server + 'sounds/kalathi.mp3',
		volume: 20,
		autoPlay: false
	});
	...
	soundManager.createSound({
		id: 'pop',
		url: globals.server + 'sounds/pop.mp3',
		volume: 20,
		autoPlay: false
	});
	...
	soundManager.createSound({
		id: 'beep',
		url: globals.server + 'sounds/beep.mp3',
		volume: 20,
		autoPlay: false
	});
	...
	soundManager.createSound({
		id: 'hiThere',
		url: globals.server + 'sounds/hiThere.mp3',
		volume: 20,
		autoPlay: false
	});
	...
	soundManager.createSound({
		id: 'blioup',
		url: globals.server + 'sounds/blioup.mp3',
		volume: 8,
		autoPlay: false
	});
	...
	soundManager.createSound({
		id: 'doorBell',
		url: globals.server + 'sounds/doorBell.mp3',
		volume: 20,
		autoPlay: false
	});
	...
	soundManager.createSound({
		id: 'kanoni',
		url: globals.server + 'sounds/kanoni.mp3',
		volume: 20,
		autoPlay: false
	});
	...
	soundManager.createSound({
		id: 'doing',
		url: globals.server + 'sounds/doing.mp3',
		volume: 20,
		autoPlay: false
	});
	...
	soundManager.createSound({
		id: 'pistolia',
		url: globals.server + 'sounds/pistolia.mp3',
		volume: 20,
		autoPlay: false
	});
	...
	soundManager.createSound({
		id: 'balothia',
		url: globals.server + 'sounds/balothia.mp3',
		volume: 20,
		autoPlay: false
	});
	...
	soundManager.createSound({
		id: 'applause',
		url: globals.server + 'sounds/applause.mp3',
		volume: 20,
		autoPlay: false
	});
	...
	soundManager.createSound({
		id: 'kanarini',
		url: globals.server + 'sounds/kanarini.mp3',
		volume: 20,
		autoPlay: false
	});
	...
	soundManager.createSound({
		id: 'korna',
		url: globals.server + 'sounds/korna.mp3',
		volume: 20,
		autoPlay: false
	});
	...
	soundManager.createSound({
		id: 'dalika',
		url: globals.server + 'sounds/dalika.mp3',
		volume: 20,
		autoPlay: false
	});
	...
	soundManager.createSound({
		id: 'klania',
		url: globals.server + 'sounds/klania.mp3',
		volume: 20,
		autoPlay: false
	});
};
