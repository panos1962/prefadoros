function init() {
	...
	setTimeout(function() {
		...
		html += '<a href="https://twitter.com/prefadorosTT" target="_blank">' +
			...
			'alt="Ο «Πρεφαδόρος» στο twitter" style="height: 0.6cm; ' +
			'margin-right: 0.1cm; padding-top: 0.1cm;" /></a>';
		html += '<a target="_blank" href="http://www.facebook.com/groups/prefadoros">' +
			'<img src="' + globals.server + 'images/facebook.jpg" alt="" ' +
			'title="Ο «Πρεφαδόρος» στο Facebook" style="height: 0.6cm; ' +
			'margin-right: 0.1cm; padding-top: 0.1cm;" /></a>';
		p.innerHTML = html;
	}, 1000);
