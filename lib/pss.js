var pss = new function() {
	...
	this.resize = function(noKeep) {
		...
		dif = 11 - pss.prosklisi.height - pss.sxesi.height - pss.sizitisi.height;
		if (dif > 0.1) {
			if (pss.sizitisi.height) { pss.sizitisi.height += dif; }
			else if (pss.sxesi.height) { pss.sxesi.height += dif; }
			else { pss.prosklisi.height += dif; }
		}
		else if (dif < -0.1) {
			if (pss.prosklisi.height) { pss.prosklisi.height += dif; }
			else if (pss.sxesi.height) { pss.sxesi.height += dif; }
			else { pss.sizitisi.height += dif; }
		}
